...
def surname(name)
  ...
  name.sub! /^(Sgt Maj|Maj Commandant|Lt Col|Pte|Dvr|SAC|Mr|Tpr|Sig|Spr|LCpl|Cpl|Sgt|CoH|SSgt|WO2|WO1|OCdt|2Lt|Lt|Capt|Maj|Col|Cnt|Cfn|Dvr\/Mec|Farr|Farr\/Sgt|Farr\/Cpl|Dvr\/IC|Farr\/SSgt|Tptr|Sgt\/Cook|Arm\/Sgt|Farr\/QMS|Cpl\/Tptr|Bandsman|Bugler|CSgt|LSgt|Rev|Dr|Mrs|Quartermaster|SCpl|WSIWSMI|WSSI|WSI|WSMI|Under Officer|Ensign|Shoeing Smith|SMI|Scpl|Sergeant Major|Sergeant Tptr|SAC|Gdm)\s+/, '' # Remove any rank
